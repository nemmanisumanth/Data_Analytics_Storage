...
Step 3: In the gender column use a case statement to spell out "male" and "female"
Step 4: Add another column using a case statement, when the average visit is
	greater than 10 then insert this value – “Greater than 10 visits”
